...
export const Route = createFileRoute("/quiz/consistencia")({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "Etapa 7 de 11 do quiz RoutyFit: o que mais dificulta sua consistência?" },
      { property: "og:title", content: "O que mais dificulta sua consistência? | RoutyFit" },
      { property: "og:description", content: "Etapa 7 de 11 do quiz RoutyFit: o que mais dificulta sua consistência?" },
