...
const config = quizSteps[2];

export const Route = createFileRoute("/quiz/nivel")({
  head: () => ({
    meta: [
      { title: "Qual é o seu nível atual? | RoutyFit" },
      { name: "description", content: "Etapa 3 de 7 do quiz RoutyFit: qual é o seu nível atual?" },
      { property: "og:title", content: "Qual é o seu nível atual? | RoutyFit" },
      { property: "og:description", content: "Etapa 3 de 7 do quiz RoutyFit: qual é o seu nível atual?" },
