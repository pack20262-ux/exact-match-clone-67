...
const config = getQuizStep("tempo");

export const Route = createFileRoute("/quiz/tempo")({
  head: () => ({
    meta: [
      { title: "Quanto tempo você tem para treinar? | RoutyFit" },
      { name: "description", content: "Etapa 6 de 11 do quiz RoutyFit: quanto tempo você tem para treinar?" },
      { property: "og:title", content: "Quanto tempo você tem para treinar? | RoutyFit" },
      { property: "og:description", content: "Etapa 6 de 11 do quiz RoutyFit: quanto tempo você tem para treinar?" },
